...
export default async () => {
    function counter() {
        inquirer.prompt([{
            ...
            if (answers.text.length == 0) {
                ...
                (console.log(`Your sentence/pargraph has ${words.length} words`));
        });
    }
    function alpabet_word() {
        inquirer.prompt([{
                name: "alpabetorword",
    ...
    function alphabets() {
        inquirer.prompt([{
            ...
            .then((answers) => {
            let abc = ["A", "a", "B", "b", "C", "c", "D", "d", "E", "e", "F", "f", "G", "g", "H", "h", "I", "i", "J", "j", "K", "k", "L", "l", "M", "m", "N", "n", "O", "o", "P", "p", "Q", "q", "R", "r", "S", "s", "T", "t", "U", "u", "V", "v", "W", "w", "X", "x", "Y", "y", "Z", "z"];
            ...
            if (answers.text.length == 0) {
                ...
                (console.log("Your sentence/pargraph has", answers.text.length, "alphabets"));
        });
    }
    alpabet_word();
};
